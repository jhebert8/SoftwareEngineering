...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        Member member1 = new Member("Alpha", 19, "Standard");
        Member member2 = new Member("Beta", 25, "Premium");
        Member member3 = new Member("Gamma", 36, "VIP");
        ...
        Console.WriteLine($"{member1.Name}, Age: {member1.Age}, Level: {member1.MembershipLevel}, " +
            $"Books Borrowed: {member1.GetBooksBorrowed()}");

        Console.WriteLine($"{member2.Name}, Age: {member2.Age}, Level: {member2.MembershipLevel}, " +
            $"Books Borrowed: {member2.GetBooksBorrowed()}");

        Console.WriteLine($"{member3.Name}, Age: {member3.Age}, Level: {member3.MembershipLevel}, " +
            $"Books Borrowed: {member3.GetBooksBorrowed()}");
        ...
        Console.WriteLine("Total Members: " + Member.TotalBooksBorrowed);
