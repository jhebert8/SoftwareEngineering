public class Member
{
    ...
    private static int standardMaxBorrowLimits = 3;
    private static int premiumMaxBorrowLimits = 5;
    private static int vipMaxBorrowLimits = 10;
    ...
    private int GetMaxBorrowLimit()
    {
        ...
        {
            return standardMaxBorrowLimits;
        }
        else if (MembershipLevel == "Premium")
        {
            return premiumMaxBorrowLimits;
        }
        else if (MembershipLevel == "VIP")
        {
            return vipMaxBorrowLimits;
        }
        else
        {
            return 0;
